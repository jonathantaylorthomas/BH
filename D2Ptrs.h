...
FUNCPTR(D2CLIENT, GetQuestInfo, void* __stdcall, (void), 0xB32D0)

FUNCPTR(D2CLIENT, SubmitItem, void __fastcall, (DWORD dwItemId), 0xB2370)
FUNCPTR(D2CLIENT, Transmute, void __fastcall, (void), 0x8A0D0)

FUNCPTR(D2CLIENT, FindClientSideUnit, UnitAny* __fastcall, (DWORD dwId, DWORD dwType), 0x63990)
FUNCPTR(D2CLIENT, FindServerSideUnit, UnitAny* __fastcall, (DWORD dwId, DWORD dwType), 0x639B0)
FUNCPTR(D2CLIENT, GetCurrentInteractingNPC, UnitAny* __fastcall, (void), 0xB1620)
FUNCPTR(D2CLIENT, GetSelectedUnit, UnitAny * __stdcall, (void), 0x67A10)
FUNCPTR(D2CLIENT, GetCursorItem, UnitAny* __fastcall, (void), 0x680A0)
FUNCPTR(D2CLIENT, GetMercUnit, UnitAny* __fastcall, (void), 0x78A90)
//FUNCPTR(D2CLIENT, UnitTestSelect, DWORD __stdcall, (UnitAny* pUnit, DWORD _1, DWORD _2, DWORD _3), 0x8D030) // unused but we need to use it

FUNCPTR(D2CLIENT, SetSelectedUnit_I, void __fastcall, (UnitAny *pUnit), 0x66DE0)
FUNCPTR(D2CLIENT, GetItemName, BOOL __stdcall, (UnitAny* pItem, wchar_t* wBuffer, DWORD dwSize), 0x8C060)
FUNCPTR(D2CLIENT, LoadItemDesc, BOOL __stdcall, (UnitAny* pItem, int type), 0x8DD90)
FUNCPTR(D2CLIENT, GetMonsterOwner, DWORD __fastcall, (DWORD nMonsterId), 0x79150)
FUNCPTR(D2CLIENT, GetUnitHPPercent, DWORD __fastcall, (DWORD dwUnitId), 0x79080)
FUNCPTR(D2CLIENT, InitInventory, void __fastcall, (void), 0x845A0)
FUNCPTR(D2CLIENT, SetUIVar, DWORD __fastcall, (DWORD varno, DWORD howset, DWORD unknown1), 0x55F20)
...
FUNCPTR(D2CLIENT, ShopAction, void __fastcall, (UnitAny* pItem, UnitAny* pNpc, UnitAny* pNpc2, DWORD dwSell, DWORD dwItemCost, DWORD dwMode, DWORD _2, DWORD _3), 0xB3870)

FUNCPTR(D2CLIENT, CloseNPCInteract, void __fastcall, (void), 0xB3F10)
//FUNCPTR(D2CLIENT, ClearScreen, void __fastcall, (void), 0x492F0) // unused but I want to look into using it // wrong function
FUNCPTR(D2CLIENT, CloseInteract, void __fastcall, (void), 0x4C6B0)

FUNCPTR(D2CLIENT, GetAutomapSize, DWORD __stdcall, (void), 0x5A710)
FUNCPTR(D2CLIENT, NewAutomapCell, AutomapCell * __fastcall, (void), 0x57C30)
FUNCPTR(D2CLIENT, AddAutomapCell, void __fastcall, (AutomapCell *aCell, AutomapCell **node), 0x57B00)
FUNCPTR(D2CLIENT, RevealAutomapRoom, void __stdcall, (Room1 *pRoom1, DWORD dwClipFlag, AutomapLayer *aLayer), 0x58F40)
FUNCPTR(D2CLIENT, InitAutomapLayer_I, AutomapLayer* __fastcall, (DWORD nLayerNo), 0x58D40)

FUNCPTR(D2CLIENT, ClickMap, void __stdcall, (DWORD MouseFlag, DWORD x, DWORD y, DWORD Type), 0x62D00)
FUNCPTR(D2CLIENT, LeftClickItem, void __stdcall, (UnitAny* pPlayer, Inventory* pInventory, int x, int y, DWORD dwClickType, InventoryLayout* pLayout, DWORD Location), 0x8FFE0)

FUNCPTR(D2CLIENT, GetMouseXOffset, DWORD __fastcall, (void), 0x5AFC0)
FUNCPTR(D2CLIENT, GetMouseYOffset, DWORD __fastcall, (void), 0x5AFB0)

FUNCPTR(D2CLIENT, PrintPartyString, void __stdcall, (wchar_t *wMessage, int nColor), 0x9E3A0) // unused but I want to look into using it too
FUNCPTR(D2CLIENT, PrintGameString, void __stdcall, (wchar_t *wMessage, int nColor), 0x9E5C0)

FUNCPTR(D2CLIENT, LeaveParty, void __fastcall, (void), 0x79FC0)

FUNCPTR(D2CLIENT, AcceptTrade, void __fastcall, (void), 0xB9070)
FUNCPTR(D2CLIENT, CancelTrade, void __fastcall, (void), 0xB90B0)
FUNCPTR(D2CLIENT, TradeOK, void __stdcall, (void), 0xB8A30)

FUNCPTR(D2CLIENT, GetDifficulty, BYTE __stdcall, (void), 0x4DCD0)

FUNCPTR(D2CLIENT, ExitGame, void __fastcall, (void), 0x4DD60)

FUNCPTR(D2CLIENT, GetUiVar_I, DWORD __fastcall, (DWORD dwVarNo), 0x538D0)

FUNCPTR(D2CLIENT, DrawRectFrame, void __fastcall, (DWORD Rect), 0x52E50)

FUNCPTR(D2CLIENT, PerformGoldDialogAction, void __fastcall, (void), 0x54080)

FUNCPTR(D2CLIENT, GetPlayerUnit, UnitAny* __stdcall, (void), 0x63DD0)

FUNCPTR(D2CLIENT, GetLevelName_I, wchar_t* __fastcall, (DWORD levelId), 0x53E70)

FUNCPTR(D2CLIENT, ClearScreen, void __fastcall, (void), 0xB4620)

FUNCPTR(D2CLIENT, CloseNPCTalk, DWORD __stdcall, (void* unk), 0xA17D0)
...
FUNCPTR(D2CLIENT, InteractA, void __fastcall, (DWORD type, DWORD unidId), 0x80930)
...
VARPTR(D2CLIENT, ScreenSizeX, DWORD, 0x31146C)
VARPTR(D2CLIENT, ScreenSizeY, DWORD, 0x311470)

VARPTR(D2CLIENT, CursorHoverX, DWORD, 0x321E4C)
VARPTR(D2CLIENT, CursorHoverY, DWORD, 0x321E50)

VARPTR(D2CLIENT, MouseY, DWORD, 0x3A6AAC)
VARPTR(D2CLIENT, MouseX, DWORD, 0x3A6AB0)

VARPTR(D2CLIENT, MouseOffsetY, int, 0x3A5208)
VARPTR(D2CLIENT, MouseOffsetZ, int, 0x3A5214)
VARPTR(D2CLIENT, MouseOffsetX, int, 0x3A520C)

VARPTR(D2CLIENT, AutomapOn, DWORD, 0x3A27E8)
VARPTR(D2CLIENT, AutomapMode, int, 0x311254)
VARPTR(D2CLIENT, Offset, POINT, 0x3A5198)
VARPTR(D2CLIENT, AutomapLayer, AutomapLayer*, 0x3A5164)

VARPTR(D2CLIENT, MercStrIndex, WORD, 0x325494)
VARPTR(D2CLIENT, MercReviveCost, DWORD, 0x3C0DD0)
...
VARPTR(D2CLIENT, ViewportY, int, 0x3A5208)
VARPTR(D2CLIENT, ViewportX, int, 0x3A520C)

VARPTR(D2CLIENT, GoldDialogAction, DWORD, 0x3A279C)
VARPTR(D2CLIENT, GoldDialogAmount, DWORD, 0x3A2A68)

VARPTR(D2CLIENT, NPCMenu, NPCMenu*, 0x326C48)
VARPTR(D2CLIENT, NPCMenuAmount, DWORD, 0x325A74)

VARPTR(D2CLIENT, TradeLayout, InventoryLayout*, 0x3BCA30)
VARPTR(D2CLIENT, StashLayout, InventoryLayout*, 0x3BCA78)
VARPTR(D2CLIENT, StoreLayout, InventoryLayout*, 0x3BCB58)
VARPTR(D2CLIENT, CubeLayout, InventoryLayout*, 0x3BCB70)
VARPTR(D2CLIENT, InventoryLayout, InventoryLayout*, 0x3BCB88)
VARPTR(D2CLIENT, MercLayout, InventoryLayout*, 0x3BCD4C)

VARPTR(D2CLIENT, RegularCursorType, DWORD, 0x3A6AF0)
VARPTR(D2CLIENT, ShopCursorType, DWORD, 0x3BCBF0)

VARPTR(D2CLIENT, Ping, DWORD, 0x3A04A4)
VARPTR(D2CLIENT, Skip, DWORD, 0x3A04B0)
VARPTR(D2CLIENT, FPS, DWORD, 0x3BB390)
VARPTR(D2CLIENT, Lang, DWORD, 0x3BB5DC)
VARPTR(D2CLIENT, Divisor, int, 0x311254)

VARPTR(D2CLIENT, OverheadTrigger, DWORD, 0x3BF20E)

VARPTR(D2CLIENT, RecentInteractId, DWORD, 0x3C0D25)

VARPTR(D2CLIENT, ItemPriceList, DWORD, 0x3C0D43)

VARPTR(D2CLIENT, TransactionDialog, void*, 0x3C0D63)
VARPTR(D2CLIENT, TransactionDialogs, DWORD, 0x3C0E5C)
VARPTR(D2CLIENT, TransactionDialogs_2, DWORD, 0x3C0E58)
VARPTR(D2CLIENT, pTransactionDialogsInfo, TransactionDialogsInfo_t*, 0x3C0E54)

VARPTR(D2CLIENT, GameInfo, GameStructInfo*, 0x3A0438)

VARPTR(D2CLIENT, WaypointTable, DWORD, 0x3BF081)

VARPTR(D2CLIENT, PlayerUnit, UnitAny*, 0x3A6A70)
VARPTR(D2CLIENT, SelectedInvItem, UnitAny*, 0x3BCBF4)
// VARPTR(D2CLIENT, SelectedUnit, UnitAny*, 0x11C4D8) // unused, but can we use it somewhere maybe? // 1.12 still
VARPTR(D2CLIENT, PlayerUnitList, RosterUnit*, 0x3BB5C0)

VARPTR(D2CLIENT, bWeapSwitch, DWORD, 0x3BCC4C)

VARPTR(D2CLIENT, bTradeAccepted, DWORD, 0x3BCE18)
VARPTR(D2CLIENT, bTradeBlock, DWORD, 0x3BCE28)

//VARPTR(D2CLIENT, RecentTradeName, wchar_t*, 0x12334C)
VARPTR(D2CLIENT, RecentTradeId, DWORD, 0x3C0E7C)

VARPTR(D2CLIENT, ExpCharFlag, DWORD, 0x3A04F4)

VARPTR(D2CLIENT, MapId, DWORD, 0x3A0638)

VARPTR(D2CLIENT, AlwaysRun, DWORD, 0x3A0660)
VARPTR(D2CLIENT, NoPickUp, DWORD, 0x3A6A90)

//VARPTR(D2CLIENT, ScreenCovered, DWORD, 0x1E8F9) // unused, appears to be an int specifying which screens (if any) are opened...

VARPTR(D2CLIENT, ChatMsg, wchar_t*, 0x3BB638)
VARPTR(D2CLIENT, OrificeId, DWORD, 0x3C547C)
VARPTR(D2CLIENT, CursorItemMode, DWORD, 0x3C5474)

VARPTR(D2CLIENT, UIMode, int, 0x3A27C0)
...
ASMPTR(D2CLIENT, TakeWaypoint_I, 0x9D0F1)

ASMPTR(D2CLIENT, ClickShopItem_I, 0xB2653)
ASMPTR(D2CLIENT, ClickBelt_I, 0x98870)
ASMPTR(D2CLIENT, ClickBeltRight_I, 0x98A90)
ASMPTR(D2CLIENT, ClickItemRight_I, 0x87740)
ASMPTR(D2CLIENT, MercItemAction_I, 0x785B0)

ASMPTR(D2CLIENT, Interact_I, 0x2B2E0)

ASMPTR(D2CLIENT, ClickParty_I, 0x79EB0) 
ASMPTR(D2CLIENT, ClickParty_II, 0x9B990)

ASMPTR(D2CLIENT, ShopAction_I, 0x7D030)

ASMPTR(D2CLIENT, GetUnitName_I, 0x64A60)
ASMPTR(D2CLIENT, GetItemDesc_I, 0x2E380)

ASMPTR(D2CLIENT, AssignPlayer_I, 0x66200)

ASMPTR(D2CLIENT, GameLoop_I, 0x4C990)

//ASMPTR(D2CLIENT, TestPvpFlag_I, 0x6A720)

ASMPTR(D2CLIENT, InputCall_I, 0x787B0)

ASMPTR(D2CLIENT, Say_I, 0x7CBDA)

ASMPTR(D2CLIENT, BodyClickTable, 0x321E58)

ASMPTR(D2CLIENT, LoadUiImage_I, 0x788B0)

ASMPTR(D2CLIENT, GetMinionCount_I, 0x78EE0)

ASMPTR(D2CLIENT, GameLeave_I, 0x81830)

ASMPTR(D2CLIENT, CongratsScreen_I, 0xF6190)
...
ASMPTR(D2CLIENT, LoadAct_2, 0x62D00)
ASMPTR(D2CLIENT, LoadAct_3, 0x591A0)

ASMPTR(D2CLIENT, GetUnitFromId_I, 0x61480)
VARPTR(D2CLIENT, pUnitTable, POINT, 0x1047B8)

ASMPTR(D2CLIENT, OverrideShrinePatch_ORIG, 0x3A3150)

ASMPTR(D2CLIENT, SendGamePacket_I, 0x78350)
ASMPTR(D2CLIENT, SendPacket_II, 0x12AE62)

////////////////////////////////////////////////////////////////////////////////////////////////
// D2Common Ordinals
////////////////////////////////////////////////////////////////////////////////////////////////

FUNCPTR(D2COMMON, InitLevel, void __stdcall, (Level* pLevel), 0x2424A0)
FUNCPTR(D2COMMON, UnloadAct, unsigned __stdcall, (Act* pAct), 0x21AFD3)
FUNCPTR(D2COMMON, GetObjectTxt, ObjectTxt* __stdcall, (DWORD objno), 0x240E90)
...
FUNCPTR(D2COMMON, GetLevelText, LevelText* __stdcall, (DWORD levelno), 0x21DB70)
FUNCPTR(D2COMMON, GetObjectText, ObjectTxt* __stdcall, (DWORD objno), 0x240E90)
FUNCPTR(D2COMMON, GetItemText, ItemText* __stdcall, (DWORD itemno), 0x2335F0)

FUNCPTR(D2COMMON, GetLayer, AutomapLayer2* __fastcall, (DWORD dwLevelNo), 0x21E470)
FUNCPTR(D2COMMON, GetLevel, Level* __fastcall, (ActMisc* pMisc, DWORD dwLevelNo), 0x242AE0)

FUNCPTR(D2COMMON, GetStatList, StatList* __stdcall, (UnitAny* pUnit, DWORD dwUnk, DWORD dwMaxEntries), 0x2257D0)
FUNCPTR(D2COMMON, CopyStatList, DWORD __stdcall, (StatList* pStatList, Stat* pStatArray, DWORD dwMaxEntries), 0x225C90)
FUNCPTR(D2COMMON, GetUnitStat, DWORD __stdcall, (UnitAny* pUnit, DWORD dwStat, DWORD dwStat2), 0x225480)
FUNCPTR(D2COMMON, GetUnitState, int __stdcall, (UnitAny* pUnit, DWORD dwStateNo), 0x239DF0)

FUNCPTR(D2COMMON, CheckUnitCollision, DWORD __stdcall, (UnitAny* pUnitA, UnitAny* pUnitB, DWORD dwBitMask), 0x222AA0)
FUNCPTR(D2COMMON, GetRoomFromUnit, Room1* __stdcall, (UnitAny* ptUnit), 0x220BB0)
FUNCPTR(D2COMMON, GetTargetUnitType, Path* __stdcall, (Path* pPath), 0x773C0)

FUNCPTR(D2COMMON, GetSkillLevel, int __stdcall, (UnitAny* pUnit, Skill* pSkill, BOOL bTotal), 0x2442A0)

FUNCPTR(D2COMMON, GetItemLevelRequirement, DWORD __stdcall, (UnitAny* pItem, UnitAny* pPlayer), 0x22BA60)

FUNCPTR(D2COMMON, GetItemPrice, DWORD __stdcall, (UnitAny* MyUnit, UnitAny* pItem, DWORD U1_,DWORD U2_,DWORD U3_,DWORD U4_), 0x22FDC0)
FUNCPTR(D2COMMON, GetRepairCost, DWORD __stdcall, (DWORD _1, UnitAny* pUnit, DWORD dwNpcId, DWORD dwDifficulty, DWORD dwItemPriceList, DWORD _2), 0x22FE60)
FUNCPTR(D2COMMON, GetItemMagicalMods, char* __stdcall, (WORD wPrefixNum), 0x233EE0)
FUNCPTR(D2COMMON, GetItemFromInventory, UnitAny *__stdcall, (Inventory* inv), 0x23B2C0)
FUNCPTR(D2COMMON, GetNextItemFromInventory, UnitAny *__stdcall, (UnitAny *pItem), 0x23DFA0)

FUNCPTR(D2COMMON, GenerateOverheadMsg, OverheadMsg* __stdcall, (DWORD dwUnk, CHAR* szMsg, DWORD dwTrigger), 0x261110)
FUNCPTR(D2COMMON, FixOverheadMsg, void __stdcall, (OverheadMsg* pMsg, DWORD dwUnk), 0x261230)

FUNCPTR(D2COMMON, AddRoomData, void __stdcall, (Act* ptAct, int LevelId, int Xpos, int Ypos, Room1* pRoom), 0x21A070)
FUNCPTR(D2COMMON, RemoveRoomData, void __stdcall, (Act* ptAct, int LevelId, int Xpos, int Ypos, Room1* pRoom), 0x21A0C0)

FUNCPTR(D2COMMON, GetQuestFlag, int __stdcall, (void* QuestInfo, DWORD dwAct, DWORD dwQuest), 0x25C310)

FUNCPTR(D2COMMON, MapToAbsScreen, void __stdcall, (long* pX, long* pY), 0x243260)
FUNCPTR(D2COMMON, AbsScreenToMap, void __stdcall, (long* ptMouseX, long* ptMouseY), 0x243510)

FUNCPTR(D2COMMON, CheckWaypoint, DWORD __stdcall, (DWORD WaypointTable, DWORD dwLevelId), 0x260E50)

FUNCPTR(D2COMMON, IsTownByLevelNo, bool __stdcall, (DWORD dwLevelNo), 0x21AAF0)
FUNCPTR(D2COMMON, GetLevelNoFromRoom, bool __stdcall, (Room1* pRoom1), 0x21A1B0)
FUNCPTR(D2COMMON, FindRoom1, Room1* __stdcall, (Act* pAct, int x, int y), 0x219DA3)

FUNCPTR(D2COMMON, GetItemPalette, int __stdcall, (UnitAny* pPlayer, UnitAny* pItem, BYTE* pColor, int nTransType), 0x22C100)

FUNCPTR(D2COMMON, GetMissileOwnerUnit, UnitAny* __fastcall, (UnitAny* pMissile), 0x639D0)
...
VARPTR(D2COMMON, sgptDataTable, DWORD, 0x344304)
...
ASMPTR(D2COMMON, DisplayOverheadMsg_I, 0x2611A0)
ASMPTR(D2COMMON, GetLevelIdFromRoom_I, 0x21A1B0)
...
FUNCPTR(D2NET, SendPacket, void __stdcall, (size_t aLen, DWORD arg1, BYTE* aPacket), 0x12AE50)
FUNCPTR(D2NET, ReceivePacket, void __fastcall, (BYTE* aPacket, DWORD aLen), 0x12AEB0)
FUNCPTR(D2NET, ReceivePacket_I, void __fastcall, (BYTE* aPacket, DWORD aLen, int* arg3), 0x12B920)
...
FUNCPTR(D2GFX, DrawLine, void __stdcall, (int X1, int Y1, int X2, int Y2, DWORD dwColor, DWORD dwUnk), 0xF6380)
FUNCPTR(D2GFX, DrawRectangle, void __stdcall, (int X1, int Y1, int X2, int Y2, DWORD dwColor, DWORD dwTrans), 0xF6300)
...
FUNCPTR(D2GFX, DrawAutomapCell2, void __stdcall, (CellContext* context, DWORD xpos, DWORD ypos, DWORD bright2, DWORD bright, BYTE *coltab), 0xF6480)

FUNCPTR(D2GFX, GetScreenSize, DWORD __stdcall, (void), 0xF5160)

FUNCPTR(D2GFX, GetHwnd, HWND __stdcall, (void), 0xF59A0)

////////////////////////////////////////////////////////////////////////////////////////////////
// D2Multi Functions
////////////////////////////////////////////////////////////////////////////////////////////////

FUNCPTR(D2MULTI, DoChat, void __fastcall, (void), 0x42810)
FUNCPTR(D2MULTI, PrintChannelText, void __stdcall, (char *szText, DWORD dwColor), 0x47AB0)
...
VARPTR(D2MULTI, ChatBoxMsg, char*, 0x37AE40)
VARPTR(D2MULTI, GameListControl, Control*, 0x398BC0)//1.13c - Unchanged
...
ASMPTR(D2MULTI, ChannelInput_I, 0x428D0)
...
VARPTR(D2LAUNCH, BnData, BnetData *, 0x3795D4)
...
FUNCPTR(D2WIN, SetControlText, void* __fastcall, (Control* box, wchar_t* txt), 0xFF5A0)
FUNCPTR(D2WIN, DrawSprites, void __fastcall, (void), 0xF9870)
FUNCPTR(D2WIN, LoadCellFile, CellFile* __fastcall, (const char* szFile, int Type), 0xFA9B0)
...
FUNCPTR(D2WIN, DrawText, void __fastcall, (const wchar_t* wStr, int xPos, int yPos, DWORD dwColor, DWORD dwUnk), 0x102320)

FUNCPTR(D2WIN, GetTextSize, DWORD __fastcall, (wchar_t* wStr, DWORD* dwWidth, DWORD* dwFileNo), 0x102520)
FUNCPTR(D2WIN, SetTextSize, DWORD __fastcall, (DWORD dwSize), 0x102EF0)
FUNCPTR(D2WIN, GetTextWidthFileNo, DWORD __fastcall, (wchar_t* wStr, DWORD* dwWidth, DWORD* dwFileNo), 0x102520)

FUNCPTR(D2WIN, DestroyEditBox, void __fastcall, (Control* pControl), 0xFDAA0)
FUNCPTR(D2WIN, DestroyControl, void __stdcall, (Control* pControl), 0xF95C0)

FUNCPTR(D2WIN, SetEditBoxCallback, void __fastcall, (Control* pControl, bool(__stdcall* FunCallBack)(Control* pControl, DWORD dwInputType, char* pChar)), 0xFDAD0)
...
FUNCPTR(D2WIN, InitMPQ, DWORD __fastcall, (const char* mpqfile, char* mpqname, int v4, int v5), 0x117332)

////////////////////////////////////////////////////////////////////////////////////////////////
// D2Win Globals
////////////////////////////////////////////////////////////////////////////////////////////////

VARPTR(D2WIN, FirstControl, Control*, 0x3D55BC)
VARPTR(D2WIN, FocusedControl, Control*, 0x3D55CC) // unused, but we ought to use it
VARPTR(D2MULTI, ChatInputBox, DWORD*, 0x398C80)

VARPTR(BNCLIENT, ClassicKey, char*, 0x482744)
VARPTR(BNCLIENT, XPacKey, char*, 0x48274C)
VARPTR(BNCLIENT, KeyOwner, char*, 0x482750)
FUNCPTR(BNCLIENT, DecodeAndLoadKeys, char __cdecl, (), 0x1234D0)

ASMPTR(BNCLIENT, DClass, 0x123673)
ASMPTR(BNCLIENT, DLod, 0x12395D)

VARPTR(STORM, WindowHandlers, WindowHandlerHashTable, 0x379300)

FUNCPTR(D2GAME, Rand, DWORD __fastcall, (DWORD* seed), 0x5C370)

FUNCPTR(D2GAME, exit0, DWORD __fastcall, (), 0x576F)
