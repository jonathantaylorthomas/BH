...
Patch* nextGame1 = new Patch(Call, D2MULTI, 0x45EFE, (int)Bnet::NextGamePatch, 5);
Patch* nextGame2 = new Patch(Call, D2MULTI, 0x46153, (int)Bnet::NextGamePatch, 5);
Patch* ftjPatch = new Patch(Call, D2CLIENT, 0x4EF28, (int)FailToJoin_Interception, 6);
